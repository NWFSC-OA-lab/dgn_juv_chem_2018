...
# dim(dShedUDA)
# Transformed File
dShedUDA <- read.csv(here("01_rawData", "2021.02.18_pH_UDA.csv"))
dim(dShedUDA)
...
# dOrion_Salinity
# dFishCareUDA_Salinity
# dHOBOppt_Salinity 


Master.temp_Salinity <- merge(dOrion_Salinity, 
                         dFishCareUDA_Salinity, 
                         by = "ObservationDate")

Master_Salinity <- merge(Master.temp_Salinity,
                         dHOBOppt_Salinity,
                         by = "ObservationDate")
