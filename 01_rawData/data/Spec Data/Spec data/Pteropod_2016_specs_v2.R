...
Pteropod_2016_Specs <- data.frame(MOATS = character(0), Date = character(0), pH = character(0))
...
for (i in 1:length(file.names)){
  ...
  colnames(SpecTemp2) <- c("MOATS","Date","pH")
  Pteropod_2016_Specs <- rbind(Pteropod_2016_Specs, SpecTemp2)
}
...
write.csv(Pteropod_2016_Specs, "Pteropod_2016_Specs.csv")
write.csv(MOATS_Stats, "MOATS_Stats.csv")
write.csv(theAnswer, "MOATS Outliers.csv")
