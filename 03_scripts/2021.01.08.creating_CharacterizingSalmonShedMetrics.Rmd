...
dtank <- read.csv(file = "2021.01.28_completeHistory_SalmonTanks.csv", 
...
## 3.) Creating dateTime objects  
#*********************************
dtank$ObservationDate <- as.POSIXct(dtank$date, tz = "UTC", "%Y-%m-%d")
...
ggplot(dtank, aes(ObservationDate, salinity)) + 
