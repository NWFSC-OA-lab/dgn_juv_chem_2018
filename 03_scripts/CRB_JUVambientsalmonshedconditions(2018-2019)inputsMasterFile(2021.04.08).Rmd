...
write.csv(pretty_wider_pH, "CRB_JUV_SalmonShed_pH_FINALsummaryWIDE_2021.04.15.csv")
...
write.csv(pretty_wider_salinity, "CRB_JUV_SalmonShed_salinity_FINALsummaryWIDE_2021.04.15.csv")
...
write.csv(pretty_wider_temp, "CRB_JUV_SalmonShed_temp_FINALsummaryWIDE_2021.04.15.csv")
...
# new name then, old name
   ...
   rename(b,
    ...
    # HOBOlogger_temp.range = "20449374",
    )
