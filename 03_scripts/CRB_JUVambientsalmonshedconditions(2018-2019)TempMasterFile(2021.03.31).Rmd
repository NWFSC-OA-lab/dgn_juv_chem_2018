...
SalmonShed_salinity_summary <- inputs_timeseries %>% group_by(ObservationMonth, treatment, sensortype) %>%
...
wideSalmonShedTempDF <- pivot_wider(SalmonShed_temp_summary,
                                    names_from = ObservationMonth)
